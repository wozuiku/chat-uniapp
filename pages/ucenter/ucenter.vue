	...
	<view class="center">
		...
		<view class="userInfo" @click.capture="toUserInfo">
			...
			<view class="user-image">
					<u-avatar v-if="userInfo.avatar_file&&userInfo.avatar_file.url" :src="userInfo.avatar_file.url" size="180"></u-avatar>
					<u-avatar v-else src="@/static/uni-center/defaultAvatarUrl.png"></u-avatar>
			</view>
		...
		<uni-grid class="grid" :column="4" :showBorder="false" :square="true">
			<uni-grid-item class="item" v-for="(item,index) in gridList" @click.native="tapGrid(index)" :key="index">
				<uni-icons class="icon" color="#EF8E5B" :type="item.icon" size="26"></uni-icons>
